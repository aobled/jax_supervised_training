...
- `tests/test_differentiable_crop_classification.py` (nouveau, racine) — script de vérification autonome (Tasks 3-5, 5 tests dont `test_boxes_are_truncated_not_kept_floating`)
