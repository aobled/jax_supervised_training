...
- Correspondance exacte confirmée entre le nom de base `output_prefix` (`jax_detector_targets`) et le préfixe codé en dur dans `dataset_builder/jax_detector_dataset_tools.py:144` — le glob de `CenterNetDetectionDataset` trouvera bien les chunks.
