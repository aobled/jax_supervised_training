...
- [Source: `_bmad-output/implementation-artifacts/7-1-definition-du-schema-dechange-heatmap-taille-ad-18.md`] — `decode_detection_targets`, formule de reconstruction de boîte à répliquer, `test_detection_target_encoding.py` cas de test réutilisables
...
- `test_peak_extraction_topk.py` (nouveau, racine) — script de vérification autonome (Task 5)
