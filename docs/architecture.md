...
3. **`train_detection.py`** est un vestige confirmé de la fusion historique JAX_Detection/JAX_Classification, à archiver (contourne le pattern Strategy).
