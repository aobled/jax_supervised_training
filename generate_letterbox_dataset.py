...
print(f"\n🚀 PROCHAINES ÉTAPES :")
print(f"   1. Générer les chunks (aucune config dataset_configs.py dédiée n'existe")
print(f"      actuellement pour ce layout Letterbox — en ajouter une avant de lancer main.py)")
