...
# Bloc protégé par if __name__ == "__main__" (corrigé lors du déplacement vers dataset_builder/ :
# ce bloc s'exécutait auparavant de façon inconditionnelle au niveau module, y compris sur un
# simple `import`, déclenchant un vrai traitement du dataset réel à chaque import du fichier).
if __name__ == "__main__":
    #------------------------------
