...
DATASET_CONFIGS = {
    ...
    "FIGHTERJET_CLASSIFICATION_64x64": {
        # === CONFIG OPTIMALE CNN 128×128 GRAYSCALE STRETCHED ===
        # === Données ===
        "num_classes": 32,
        "class_names": ['a10', 'a4', 'a400m', 'alphajet', 'b1b', 'b2', 'b52', 'c130', 'c17', 'f117', 'f14', 'f15', 'f16', 'f18', 'f22', 'f35', 'f4', 'flanker', 'gripen', 'harrier', 'hawk', 'hawkeye', 'mig29', 'mirage2000', 'mustang', 'rafale', 'spitfire', 'sr71', 'su57', 'tornado', 'typhoon', 'v22'],
        "data_dir": "/home/aobled/Downloads/_balanced_dataset_split",
        "output_prefix": f"{DATA_ROOT}/chunks/classification_64x64/dataset_classification_64x64",
        "chunk_size": 30000,
        "image_size": (64, 64),
        "grayscale": True,  # ✅ GRAYSCALE (3× plus rapide, même accuracy)
        "augmentation_params": {
        ...
        # -> best_model_fighterjet_classification_64x64.pkl / best_model_training_state_fighterjet_classification_64x64.pkl
        # Volontairement distinct de FIGHTERJET_CLASSIFICATION (best_model.pkl = checkpoint de production, ne pas écraser)
        "confusion_matrix_path": "confusion_matrix_classification_64x64.png",
    },
